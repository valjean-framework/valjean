...
class RunTaskFactory:
    ...
    @classmethod
    def from_task(cls, task, *, relative_path, uid=None, default_args=None,
                  **kwargs):
        ...
        :param uid: a unique identifier for this factory. The UID is used to
            produce unique names for the task generated by the factory. If
            `None` is given, the factory will construct a UID by hashing the
            other arguments.
        ...
        return cls(closure, deps=[task], uid=uid, **kwargs)
