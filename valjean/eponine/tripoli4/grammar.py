...
_scorevolumeint_kw = Keyword("The result is integrated in volume")
_scorevolumenotint_kw = Keyword("The volume has been calculated by TRIPOLI-4 "
...
_respname = (Suppress(_respname_kw + ':')
             + (Suppress(LineEnd())
                | Optional(Word(alphanums + '_. ')('response_name'))))
...
_score_vol = (_scorevol_kw('scoring_zone_type')
              ...
              + _fnums('scoring_zone_volsurf')
              + Optional(Suppress(_scorevolumeint_kw | _scorevolumenotint_kw)))
