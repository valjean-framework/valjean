...
# 
# Cette fonction prépare les jeux de données TRIPOLI-4 et MCNP en remplissant les cases vides de fichiers templates ([TRIPOLI-4](templates/t4), [MCNP](templates/mcnp)).
